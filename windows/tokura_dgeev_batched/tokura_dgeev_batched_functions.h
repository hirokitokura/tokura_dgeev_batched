#ifndef __TOKURA_DGEEV_BATCHED_FUNCTIONS__
#define __TOKURA_DGEEV_BATCHED_FUNCTIONS__
...
(
	...
	const int mat_num,
	double*  a_o,
	const int doubleqr_join_num,
	double *comp_real,
	double *comp_imag,
	char* flags
);

__global__ void tokura_matrixrearrangement_MWtoEW
(
	const int n,
	const double* __restrict__ a,
	double *a2, 
	const int batchCount_per_stream
);

__global__ void tokura_eigenvaluesrearrangement_EWtoMW
(
	const int n,
	const  int mat_num,
	const double* __restrict__ comp_real,
	const double* __restrict__ comp_imag,
	double *comp_real_out, 
	double *comp_imag_out
);
